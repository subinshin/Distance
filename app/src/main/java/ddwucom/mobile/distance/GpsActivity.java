...
public class GpsActivity extends AppCompatActivity implements OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback{
    ...
    //통합 위치 정보 제공자에 관한 요청의 매개변수를 저장하려면 LocationRequest를 만듭니다
...
///////
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        int hasFineLocationPermission = ContextCompat.checkSelfPermission(this,
                Manifest.permission.ACCESS_FINE_LOCATION); // 정확도가 높은 gps (느림)
        int hasCoarseLocationPermission = ContextCompat.checkSelfPermission(this,
                Manifest.permission.ACCESS_COARSE_LOCATION); // 네트워크 연결 안됐을 때 사용되는 gps (빠름)
